...
#include <memory>
#include "../../../Src/Video/VideoRecord.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoRecord_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VideoRecord_t qt_meta_stringdata_VideoRecord = {
    {
QT_MOC_LITERAL(0, 0, 11) // "VideoRecord"
...
QT_INIT_METAOBJECT const QMetaObject VideoRecord::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_VideoRecord.data,
    qt_meta_data_VideoRecord,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VideoRecord::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoRecord.stringdata0))
