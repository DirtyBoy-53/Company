...
void combine(YTableCell& a, YTableCell& b, YTableCell& comb) {
    comb.r1 = std::min(a.r1, b.r1);
    comb.r2 = std::max(a.r2, b.r2);
    comb.c1 = std::min(a.c1, b.c1);
    comb.c2 = std::max(a.c2, b.c2);
}

bool overlap(YTableCell& a, YTableCell& b, YTableCell& inter, YTableCell& comb) {
    inter.r1 = std::max(a.r1, b.r1);
    inter.r2 = std::min(a.r2, b.r2);
    inter.c1 = std::max(a.c1, b.c1);
    inter.c2 = std::min(a.c2, b.c2);
