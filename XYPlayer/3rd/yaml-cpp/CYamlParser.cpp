...
template<>
uint32_t CYamlParser::get(const std::string& key, const std::string& section, const uint32_t &defaultValue)
{
    return m_Impl->read<uint32_t>(key, section, defaultValue);
}
...
template<>
bool CYamlParser::get(const std::string& key, const std::string& section, const bool &defaultValue)
{
    return m_Impl->read<bool>(key, section, defaultValue);
}
/*
 * set
 * Passing values ​​using member function templates
...
template<>
bool CYamlParser::set(const std::string &key, const bool &value, const std::string &section)
{
    return m_Impl->write<bool>(key, value, section);
}
