#ifndef AUTOPROCESSCHECKCB_H
#define AUTOPROCESSCHECKCB_H
/*
** 文件说明: 控制盒锁附工序专用代码文件
** 作    者:
** 修改历史: 2024年1月11日 创建文件
** 版权信息：
*/
...
class AutoProcessElecLockCB : public BaseProduce
{
    Q_OBJECT
public:
    AutoProcessElecLockCB();
    bool initConnect();
