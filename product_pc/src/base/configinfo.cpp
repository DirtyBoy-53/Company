...
static XmlConfigInfo g_xmlInfo[MaxConfigNum] = {
    ...
    {"GLOBAL","项目选择",  "XD01A", "Enum", LOGIN_ADMIN,"XD01A,XD01B,XD02A,XD03A,Sensor,Motan"},
    ...
    {"CL1005","DisCurIP", "192.168.2.250", "String", LOGIN_NORMAL,""},
    ...
    {"CB1005", "PrintTemplatePath", "E:/data", "FilePath", LOGIN_ADMIN,""},
    {"CB1005", "OnlineTemplate", "True", "Enum", LOGIN_ADMIN,"True,False"},
    ...
    {"CL1007", "PrintTemplatePath", "E:/data", "FilePath", LOGIN_ADMIN,""},
    {"CL1007", "OnlineTemplate", "True", "Enum", LOGIN_ADMIN,"True,False"},
