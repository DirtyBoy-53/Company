...
void MtfUtils::Gethanmingwin(float* hamming, int n_len, float mid)
{
	float wid1 = mid - 1;
...
void MtfUtils::Getloc(float* loc, float* src_grad, int n_width, int n_height)
{
	float sum, sumx;
...
void MtfUtils::findedge(float* Cen_Shifts, int n_len, float& a, float& b)
{
	b = 0.f;
...
void MtfUtils::cent(float* puc_dst, float* puc_src, int n_len, float center)
{
