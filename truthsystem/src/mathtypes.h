...
#define Radians(A)               A*PiOver180
#define Degrees(A)               A*PiUnder180
#define CosD(A)                  cos(A*PiOver180)
#define SinD(A)                  sin(A*PiOver180)
#define TanD(A)                  tan(A*PiOver180)
#define ATanD(A)                 atan(A*PiOver180)
#define ACosD(A)                 Degrees(acos(A))
#endif
